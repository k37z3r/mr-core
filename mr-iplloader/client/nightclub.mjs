...
import { EnableIpl, getInteriorByType, SetIplProp, get_posters, drawTv, CreateNamedRenderTargetForModel, RegisterPoi, _L } from 'mr-functions';
let tvactive = false;
...
/*	if (distance_exit < 1.5){
		drawText("Drück [38] um Nightclub zu verlassen");
		if (native.isControlPressed(1, 38)){
			alt.emitServer('mr-iplloader:entry', {x:988, y:80, z:-81.5, w:0});
		}
	}
	else{
		hideText();
