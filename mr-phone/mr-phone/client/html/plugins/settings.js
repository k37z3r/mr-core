...
$(document).ready(function(){
	$(document).on('click', '#phone_settings', function(e) {
		...
		element = '<input type="hidden" style="display:none;" value="phone_settings" class="fake_id_to_load_from_cache"><div class="phone_settings"><div id="phone_ringtones_call" class="settings_menu">Anruf-Klingelton<i id="phone_ringtones_call_pm" class="fa-solid fa-plus"></i></div><div id="sub_phone_ringtones_call" style="display:none;"></div><div id="phone_ringtones_sms" class="settings_menu">SMS-Nachrichtenton<i id="phone_ringtones_sms_pm" class="fa-solid fa-plus"></i></div><div id="sub_phone_ringtones_sms" style="display:none;"></div><div id="phone_ringtones_whatsapp_call" class="settings_menu">Whatsapp-Anrufklingelton<i id="phone_ringtones_whatsapp_call_pm" class="fa-solid fa-plus"></i></div><div id="sub_phone_ringtones_whatsapp_call" style="display:none;"></div><div id="phone_ringtones_whatsapp_msg" class="settings_menu">Whatsapp-Nachrichtenton<i id="phone_ringtones_whatsapp_msg_pm" class="fa-solid fa-plus"></i></div><div id="sub_phone_ringtones_whatsapp_msg" style="display:none;"></div><div id="phone_ringtones_discord_msg" class="settings_menu">Discord-Nachrichten-ton<i id="phone_ringtones_discord_msg_pm" class="fa-solid fa-plus"></i></div><div id="sub_phone_ringtones_discord_msg" style="display:none;"></div><div id="phone_ringtones_email" class="settings_menu">eMail-Nachrichtenton<i id="phone_ringtones_email_pm" class="fa-solid fa-plus"></i></div><div id="sub_phone_ringtones_email" style="display:none;"></div><div id="phone_ringtones_volume" class="settings_menu">Lautstärke<i id="phone_ringtones_volume_pm" class="fa-solid fa-plus"></i></div><div id="sub_phone_ringtones_volume" style="display:none;"><div class="sub_menu">Anruf-Klingelton: <input type="range" min="0" max="1" step="0.01" class="sound_slider" id="phone_ringtones_call_volume"></div><div class="sub_menu">SMS-Nachrichtenton: <input type="range" min="0" max="1" step="0.01" class="sound_slider" id="phone_ringtones_sms_volume"></div><div class="sub_menu">Whatsapp-Anrufklingelton: <input type="range" min="0" max="1" step="0.01" class="sound_slider" id="phone_ringtones_whatsapp_call_volume"></div><div class="sub_menu">Whatsapp-Nachrichtenton: <input type="range" min="0" max="1" step="0.01" class="sound_slider" id="phone_ringtone_whatsapp_msg_volume"></div><div class="sub_menu">Discord-Nachrichten-ton: <input type="range" min="0" max="1" step="0.01" class="sound_slider" id="phone_ringtones_discord_msg_volume"></div><div class="sub_menu">eMail-Nachrichtenton: <input type="range" min="0" max="1" step="0.01" class="sound_slider" id="phone_ringtones_email_volume"></div><div class="sub_menu">Tastentöne: <input type="range" min="0" max="1" step="0.01" class="sound_slider" id="soundtouched_volume"></div></div><div id="phone_keytones" class="settings_menu">Tastentöne<i id="phone_keytones_pm" class="fa-solid fa-plus"></i></div><div id="sub_phone_keytones" style="display:none;"><div class="sub_menu">Hörbar: <div id="soundtouched_bgd" class="slider_bgd"><div id="soundtouched" class="slider"></div></div></div><div class="sub_menu">Sichbar: <div id="seetouched_bgd" class="slider_bgd"><div id="seetouched" class="slider"></div></div></div></div><div id="phone_background_image" class="settings_menu">Hintergrundbild<i id="phone_background_image_pm" class="fa-solid fa-plus"></i></div><div id="sub_phone_background_image" style="display:none;"><div class="sub_menu_img"></div></div><div id="phone_default_settings" class="settings_menu">Werkseinstellung</div><div id="default_settings_confirm" style="display:none;"><div class="default_setting_confirm_content"><div class="default_setting_confirm_header">Werkseinstellung?</div><div class="default_setting_confirm_text">Willst du wirklich die Werkseinstellungen laden?<br><br>*Telefonbucheinträge, Discord, Whatsapp, Bilder, SMS bleiben unberührt</div><div class="default_setting_confirm_buttons"><div class="confirm_button" id="phone_default_settings_yes">Ja</div><div class="confirm_button" id="phone_default_settings_no">Nein</div></div></div></div></div>';
